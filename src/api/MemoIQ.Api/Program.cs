...
using System.Text;
using MemoIQ.Api.Middleware;
using MemoIQ.Infrastructure.Configuration;
using MemoIQ.Infrastructure.Repositories;
using MemoIQ.Infrastructure.Services;
using MemoIQ.Service.Services;
using UserModel = MemoIQ.Infrastructure.Models.User;
using AgentModel = MemoIQ.Infrastructure.Models.Agent;
using ServiceModel = MemoIQ.Infrastructure.Models.Service;
